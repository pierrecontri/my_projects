...
<table style="width:100%;">
    <tr>
        <td>
            <asp:Label ID="LabelMachineName" CssClass="labelMachine" runat="server" Text="Label" Width="150px"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
    <td>
    <asp:TextBox ID="TextBoxErrors" runat="server" ReadOnly="True" Rows="4" 
