...
<div class="ServiceControlContent">
    ...
    &nbsp;&nbsp;&nbsp;
        <asp:HyperLink ID="HyperLinkMachineDetails" CssClass="labelMachine" runat="server" 
            Target="SrvManagmentMachineDetails" NavigateUrl="~/HardwareDetails.aspx" 
            onload="HyperLinkMachineDetails_Load">(Details)</asp:HyperLink>
    </div>
