========================================================================
    APPLICATION CONSOLE&nbsp;: Vue d'ensemble du projet TestConsoleWin32
========================================================================

AppWizard a cr&eacute;&eacute; cette application TestConsoleWin32 pour vous.

Ce fichier contient un r&eacute;sum&eacute; des &eacute;l&eacute;ments contenus dans chaque fichier qui
constitue votre application TestConsoleWin32.


TestConsoleWin32.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    nomm&eacute; TestConsoleWin32.pch et un fichier de types pr&eacute;compil&eacute;s nomm&eacute; StdAfx.obj.
